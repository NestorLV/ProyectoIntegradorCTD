...
export default function ScoreStar({ qualification, starColor }) {
    ...
    return (
        <div className={Styles.calificacionEstrellas}>
            {qualification >= 2 ? star : (qualification % 2 >= 1 && qualification > 0) ? halfStar : null}
            {qualification >= 4 ? star : (qualification % 2 >= 1 && qualification > 2) ? halfStar : null}
            {qualification >= 6 ? star : (qualification % 2 >= 1 && qualification > 4) ? halfStar : null}
            {qualification >= 8 ? star : (qualification % 2 >= 1 && qualification > 6) ? halfStar : null}
            {qualification >= 10 ? star : (qualification % 2 >= 1 && qualification > 8) ? halfStar : null}
        </div>
    )
